<template>
  <div>
    ...
    <div v-if="posts.status == 200" class="l" >Ссылка на заметку: <a :href="posts.url" target="_blank">{{ posts.url }}</a></div>
...
<div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div>
 ...
 <div class="linkCreateClass">Все ссылки действительны в течении 72 часов</div>
  ...
  <div class='to-share'><div><a :href="'https://api.whatsapp.com/send?text=url=' + posts.url" style="margin-right: 10px;  float:left">
<img   style="width: 50px;"  src="https://i.pinimg.com/originals/a7/9b/68/a79b687ea194584379449e01fb63401b.png">
</a></div>
<div><a :href="'https://vk.com/share.php?url=' + posts.url" target="_blank" ><img  src="https://iwiki.su/wp-content/uploads/2014/04/VK.com-logo.svg_.png"   alt=""></a>
</div>
<div style="position: absolute; left: 110px; bottom: 65px"><a :href="'https://t.me/share/url?url=' + posts.url + '&text=Заметки'" target="_blank" ><img  src="https://img.icons8.com/?size=100&id=63306&format=png&color=000000"   alt=""></a>
</div>
</div>
